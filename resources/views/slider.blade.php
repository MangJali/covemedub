    ...
    <div class="container mt-5">
        ...
        <form action="{{url('admin/slider/create')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <textarea rows="3" class="form-control" placeholder="Tuliskan konten slider" name="konten" required></textarea>
                </div>
            </div>
        </form>
    </div>
...
<section>
    <div class="container mt-5">
        <div class="mb-3 row justify-content-between">
            <h1 class="col">List Slider</h1>
            <form action="{{url('admin/slider')}}" class="col-sm-12" method="GET">
        ...
        <div class="row justify-content-between mb-1">
            ...
            <div class="col d-flex justify-content-end">
                ...
                <form action="{{url('admin/slider/remove/'.$val->id)}}" class="ms-2" method="POST">
                    @csrf
                    @method('delete')
        ...
        <form action="">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <img src="{{asset('upload_file/'.$val->link_gambar)}}" alt="" class="w-100" style="max-width: 300px;">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="staticEmail" class="col-sm-2 col-form-label">Konten</label>
                <div class="col-sm-10">
                    <textarea rows="3" readonly class="form-control" placeholder="Tuliskan konten slider" name="konten" required>{{$val->konten}}</textarea>
                </div>
            </div>
        </form>
        <hr>
...
<script>
    ...
    exampleModal.addEventListener('show.bs.modal', function(event) {
        ...
        form.action = "{{url('admin/slider/edit')}}/" + obj.id
