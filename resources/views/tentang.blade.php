    ...
    <main class="text-center">
        ...
        <section class="position-relative mt-4 pt-5 pb-5">
            <div class="position-absolute top-0 end-0" style="overflow: hidden;z-index: -1;">
                <img src="{{asset('assets/Team meeting_Two Color.svg')}}" alt="#" style="width: 50vmax; transform: translate(60%,-20%);">
            </div>
            ...
            <div class="container-xxl " style="z-index: 1;">
                <div class="row ">
                    ...
                    <div class="col-12 " style="font-size: 1.5vmax; ">
                        <p class="text-start fst-italic ">COVIMED (COVID-19 Maternal-Child Education) merupakan website yang berisikan informasi Kesehatan untuk ibu dan janinnya, khususnya selama Pandemi Covid-19. Ibu dan keluarga akan mendapatkan informasi seputar pemeriksaan kehamilan selama pandemic Covid-19, tanda bahaya kehamilan, penyakit yang muncul selama masa kehamilan, dll.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="position-absolute bottom-0 start-0" style="overflow: hidden;z-index: -1;">
                <img src="{{asset('assets/Team meeting_Two Color.svg')}}" alt="#" style="width: 50vmax; transform: translate(-50%,5%);">
            </div>
        </section>
            ...
            <div class="container pt-5 mt-5">
                <div class="row">
                    <div class="col-3 justify-content-center">
                        <img class="w-100" src="{{asset('assets/avatar_cowok.svg')}}" alt="">
                        <br>
                        <br>
                    ...
                    <div class="col-3 justify-content-center">
                        <img class="w-100" src="{{asset('assets/avatar_cewek.svg')}}" alt="">
                        <br>
                        <br>
