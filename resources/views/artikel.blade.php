<section>
    <div class="container mt-5">
        ...
        @endif
        <form action="{{url('admin/artikel/create')}}" method="POST">
            @csrf
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="judul" value="" placeholder="Tuliskan judul artikel" required>
                </div>
            </div>
            <div class="mb-3 row">
                <label for="staticEmail" class="col-sm-2 col-form-label">Konten</label>
                <div class="col-sm-10">
                    <textarea rows="3" class="form-control" placeholder="Tuliskan konten artikel" name="isi" required></textarea>
                </div>
            </div>
        </form>
    </div>
...
<section>
    <div class="container mt-5">
        <div class="mb-3 row justify-content-between">
            <h1 class="col">List Artikel</h1>
            <form action="{{url('admin/artikel')}}" class="col-sm-12" method="GET">
        ...
        <div class="row justify-content-between mb-1">
            ...
            <div class="col d-flex justify-content-end">
                ...
                <form action="{{url('admin/artikel/remove/'.$val->id)}}" class="ms-2" method="POST">
                    @csrf
                    @method('delete')
        ...
        <form action="">
            <div class="mb-3 row">
                <label for="staticEmail" class="col-sm-2 col-form-label">Judul</label>
                <div class="col-sm-10">
                    <input type="text" readonly class="form-control" id="staticEmail" value="{{$val->judul}}" placeholder="-" required>
                </div>
            </div>
            <div class="mb-3 row">
                <label for="staticEmail" class="col-sm-2 col-form-label">Konten</label>
                <div class="col-sm-10">
                    <textarea rows="3" readonly class="form-control" placeholder="Tuliskan konten artikel" name="isi" required>{{$val->isi}}</textarea>
                </div>
            </div>
        </form>
        <hr>
...
<script>
    ...
    exampleModal.addEventListener('show.bs.modal', function(event) {
        ...
        form.action = "{{url('admin/artikel/edit')}}/" + obj.id
        form["id"].value = obj.id
        form["judul"].value = obj.judul
        form["isi"].value = obj.isi
    })
</script>